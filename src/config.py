...
GLOVE_PATH     = os.path.join(BASE_DIR, "data", "glove.840B.300d.txt")  #If the word vector file is not provided, it can be ignored.

# Model and training hyperparameter configuration
BATCH_SIZE    = 32      # Batch size can be adjusted according to the available memory.
